/**
 * @file    system_stm32l432kc.c
 * @brief   Early system init for STM32L432KC on NUCLEO-L432KC.
 *
 *   - Voltage scaling: Range 1 (required for SYSCLK > 26 MHz per RM0394 §5.1.5)
 ...
 * IOsonata/ARM/ST/STM32L4xx/STM32L432KC/ without pulling in HAL dependencies.
 */

#include <stdint.h>

/* ------ Peripheral bases (RM0394 §2.2.2 Memory map) ---------------------- */
