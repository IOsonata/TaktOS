...
/* Tick-granularity sleep: suspends calling thread for exactly 'ticks' RTOS ticks.
 * At 1 kHz tick rate, tm_thread_sleep_ticks(1) = 1 ms.
 * Use in the barging test to get ~1000 interloper wakeups/s instead of ~1/s. */
