...
TM1 cooperative scheduling comparison project for nRF54L15 + Eclipse ThreadX.
...
- threadx/
  - common/inc/
  - common/src/
  - ports/cortex_m33/gnu/inc/
  - ports/cortex_m33/gnu/src/
...
Be sure the GNU Cortex-M4 port file `threadx/ports/cortex_m33/gnu/src/tx_initialize_low_level.S` is present and built.

Selected benchmark source: `basic_processing.c`
