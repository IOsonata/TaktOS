...
// -----------------------------------------------------------------------------
// ThreadX bare-metal STM32L475VG port for the official Thread-Metric harness.
//
// Target: B-L475E-IOT01A2, STM32L475VGT6, Cortex-M4F @ 80 MHz.
// UART  : USART1 on PB6/PB7 (AF7), 115200 8N1 (in tm_console_stm32l475vg.cpp - shared).
...
// weak aliases in startup_stm32l475vg.S at link time.
// -----------------------------------------------------------------------------
 ...
 * Matches the TaktOS port sizing for comparable numbers on 96 KB SRAM1. */
...
// TIM7_IRQn = 55 (STM32L475xx). Pended only - TIM7 is never clocked.
// -----------------------------------------------------------------------------
...
// Strong symbol overrides the weak alias in startup_stm32l475vg.S.
// -----------------------------------------------------------------------------
