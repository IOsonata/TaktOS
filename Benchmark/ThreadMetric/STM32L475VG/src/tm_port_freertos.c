...
// -----------------------------------------------------------------------------
// FreeRTOS bare-metal STM32L475VG port for the official Thread-Metric harness.
//
// Target: B-L475E-IOT01A2, STM32L475VGT6, Cortex-M4F @ 80 MHz.
// UART  : USART1 on PB6/PB7 (AF7), 115200 8N1, ST-LINK/V2-1 Virtual COM Port.
// Tick  : 1000 Hz.
// SW IRQ: TIM7_IRQn (IRQ 55) - pended only; TIM7 is never clocked.
//
// The startup_stm32l475vg.S, system_stm32l432kc.c, gcc_stm32l432kc.ld, and
// tm_console_stm32l475vg.cpp files are shared with the TaktOS and ThreadX
...
/* Stack sizing for STM32L475VG (96 KB SRAM1).
...
#define SW_IRQ_N                     55u     // TIM7_IRQn on STM32L475xx
...
// symbol here to override the weak alias from startup_stm32l475vg.S.
