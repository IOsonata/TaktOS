...
Official Thread-Metric MessageProcessing comparison project for nRF52832 + FreeRTOS.
...
## Notes
- Same official Thread-Metric MessageProcessing test source as the TaktOS project.
...
Selected test source: `message_processing.c`
