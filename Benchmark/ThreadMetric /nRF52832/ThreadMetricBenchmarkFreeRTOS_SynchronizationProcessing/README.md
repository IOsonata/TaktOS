...
Official Thread-Metric SynchronizationProcessing comparison project for nRF52832 + FreeRTOS.
...
## Notes
- Same official Thread-Metric SynchronizationProcessing test source as the TaktOS project.
