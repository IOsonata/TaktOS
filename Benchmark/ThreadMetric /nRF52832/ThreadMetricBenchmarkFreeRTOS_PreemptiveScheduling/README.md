...
Official Thread-Metric PreemptiveScheduling comparison project for nRF52832 + FreeRTOS.
...
## Notes
- Same official Thread-Metric PreemptiveScheduling test source as the TaktOS project.
...
Selected test source: `preemptive_scheduling.c`
