...
Official Thread-Metric CooperativeScheduling comparison project for nRF52832 + FreeRTOS.
...
## Notes
- Same official Thread-Metric CooperativeScheduling test source as the TaktOS project.
...
Selected test source: `cooperative_scheduling.c`
