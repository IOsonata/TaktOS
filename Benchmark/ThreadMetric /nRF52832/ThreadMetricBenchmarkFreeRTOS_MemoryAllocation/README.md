...
Official Thread-Metric MemoryAllocation comparison project for nRF52832 + FreeRTOS.
...
## Notes
- Same official Thread-Metric MemoryAllocation test source as the TaktOS project.
...
Selected test source: `memory_allocation.c`
