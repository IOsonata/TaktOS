...
Official Thread-Metric BasicProcessing comparison project for nRF52832 + FreeRTOS.
...
## Notes
- Same official Thread-Metric BasicProcessing test source as the TaktOS project.
...
Selected test source: `basic_processing.c`
