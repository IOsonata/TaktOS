 ...
 * Design
 * ------
 *   4 worker threads  at TM priority 10   (IDs 0–3)
 *   4 interloper threads at TM priority 3  (IDs 4–7)
 ...
 * priority-ordered wait-list insertion on roughly 1–2% of all grants.
 *
...
#define TM_BARGE_NUM_WORKERS      4   /* threads 0–3, TM priority 10 */
#define TM_BARGE_NUM_INTERLOPERS  4   /* threads 4–7, TM priority  3 */
