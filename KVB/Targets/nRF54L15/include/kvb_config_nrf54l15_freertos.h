/**-------------------------------------------------------------------------
 * @file    kvb_config_nrf54l15_freertos.h
 * @brief   KVB build configuration for nRF54L15-DK + FreeRTOS.
 *
 ...
 *
 * Memory budget (256 KB SRAM total) — comfortable on this target.  FreeRTOS
 * V11.3 on Cortex-M33 has its TCB outside the caller-supplied stack (TCB
 ...
 * needed.  This matches the proven Benchmark/ThreadMetric/nRF54L15
 ...
 * apply on Cortex-M33.
 * -------------------------------------------------------------------------*/
#ifndef KVB_CONFIG_NRF54L15_FREERTOS_H
#define KVB_CONFIG_NRF54L15_FREERTOS_H
...
#endif /* KVB_CONFIG_NRF54L15_FREERTOS_H */
