/**-------------------------------------------------------------------------
 * @file    kvb_config_nrf54l15_threadx.h
 * @brief   KVB build configuration for nRF54L15-DK + Eclipse ThreadX.
 *
 ...
 *
 * Memory budget (256 KB SRAM total).  Comfortable on this target.
 *
 ...
 *      frame to every public API call.  On Cortex-M33 the cost is smaller
 ...
 *                    Benchmark/ThreadMetric/nRF54L15 reference build.
 ...
 * -------------------------------------------------------------------------*/
#ifndef KVB_CONFIG_NRF54L15_THREADX_H
#define KVB_CONFIG_NRF54L15_THREADX_H
...
#endif /* KVB_CONFIG_NRF54L15_THREADX_H */
